namespace Boma.RedeSocial.Infrastructure.Data.Migrations
{
    ...
    public partial class StartDb : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        UpdateBy = c.String(maxLength: 100, unicode: false),
                        DeletedAt = c.DateTime(),
                        DeleteBy = c.String(maxLength: 100, unicode: false),
                        AccountType = c.Int(),
                        SubscriptionType = c.Int(),
                        UrlProfilePhoto = c.String(),
                        PasswordResetKey = c.String(),
                        Discriminator = c.String(nullable: false, maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .Index(t => t.Email, unique: true, name: "IDX_Users_Email")
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.AspNetUsers", "IDX_Users_Email");
